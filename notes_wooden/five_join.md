...
- update primary key and relate to foreign key

```SQL
CREATE TABLE REP 
(REP_NUM VARCHAR2(2) PRIMARY KEY,
LAST_NAME CHAR(15),
FIRST_NAME CHAR(15), 
STREET CHAR(15),
CITY CHAR(15),
...
(CUSTOMER_NUM VARCHAR2(3) PRIMARY KEY,
...
CREATE TABLE ORDERS 
(ORDER_NUM VARCHAR2(5) PRIMARY KEY,
ORDER_DATE DATE,
CUSTOMER_NUM VARCHAR2(3),
FOREIGN KEY (CUSTOMER_NUM) REFERENCES CUSTOMER(CUSTOMER_NUM));

CREATE TABLE ITEM 
(ITEM_NUM VARCHAR2(4) PRIMARY KEY,
DESCRIPTION CHAR(30),
ON_HAND DECIMAL(4,0),
CATEGORY CHAR(3),
STOREHOUSE CHAR(1),
...
INSERT INTO ORDERS
VALUES
('51608',to_date('10-12-2015','MM-DD-YYYY'),'126');
INSERT INTO ORDERS
VALUES
('51610',to_date('10-12-2015','MM-DD-YYYY'),'334');
INSERT INTO ORDERS
VALUES
('51613',to_date('10-13-2015','MM-DD-YYYY'),'386');
INSERT INTO ORDERS
VALUES
('51614',to_date('10-13-2015','MM-DD-YYYY'),'260');
INSERT INTO ORDERS
VALUES
('51617',to_date('10-15-2015','MM-DD-YYYY'),'586');
INSERT INTO ORDERS
VALUES
('51619',to_date('10-15-2015','MM-DD-YYYY'),'126');
INSERT INTO ORDERS
VALUES
('51623',to_date('10-15-2015','MM-DD-YYYY'),'586');
INSERT INTO ORDERS
VALUES
('51625',to_date('10-16-2015','MM-DD-YYYY'),'796');
INSERT INTO ITEM
VALUES
...
```
```Markdown
| REP_NUM | LAST_NAME | CUSTOMER_NAME              | ORDER_NUM | NUM_ORDERED | DESCRIPTION                  | PRICE  |
|---------|-----------|----------------------------|-----------|-------------|------------------------------|--------|
| 15      | Campos    | Toys Galore                 | 51608     | 5           | Wood Block Set (48 piece)     | 89.49  |
| 30      | Gradey    | Johnson's Department Store  | 51613     | 5           | Classic Railway Set           | 107.95 |
| 45      | Tian      | Almondton General Store     | 51623     | 5           | Giant Star Brain Teaser       | 31.95  |
| 15      | Campos    | Toys Galore                 | 51619     | 2           | Rocking Horse                 | 124.95 |
| 30      | Gradey    | Brookings Direct            | 51614     | 1           | Rocking Horse                 | 124.95 |
| 45      | Tian      | Almondton General Store     | 51623     | 12          | Puzzle Gift Set               | 38.95  |
| 45      | Tian      | Almondton General Store     | 51623     | 10          | Pentominoes Brain Teaser      | 14.95  |
| 45      | Tian      | The Everything Shop         | 51610     | 25          | Pick Up Sticks                | 10.95  |
| 45      | Tian      | Unique Gifts                | 51625     | 8           | Zauberkasten Brain Teaser     | 45.79  |
| 45      | Tian      | Almondton General Store     | 51617     | 4           | Wood Block Set (62 piece)     | 119.75 |
| 45      | Tian      | The Everything Shop         | 51610     | 10          | Tic Tac Toe                   | 13.99  |
| 45      | Tian      | Almondton General Store     | 51617     | 3           | Fire Engine                   | 118.95 |
```
